 ...
 * - Cada atributo deve possuir UM método de input (setter) e UM médoto de output (getter)
 * Cada classe deve possuir no mínimo dois contrutores (um vazio e outro cheio - com todos os atributos)
 */
public class Aluno {
	private int rm;
	private String nome;
