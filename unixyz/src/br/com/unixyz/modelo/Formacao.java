...
/*
 * Polimorfimo: é quando o mesmo método possui comportamentos diferentes e o mesmo nome.
 * 2 tipos:
 * Overload(Sobrecarga): quando os médotods estão na mesma classe, com assinaturas diferentes. Exemplo: retornarMedia()
 * Override (sobrescrita): quando os métodos estão em classes diferentes, podem possuir a mesma assinatura. Exemplo: getAll()
 */
